  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        ...
        p-1 hover:bg-accent hover:text-accent-foreground active:bg-accent/80 active:text-accent-foreground disabled:bg-muted disabled:text-muted-foreground
        ">
          <XIcon />
